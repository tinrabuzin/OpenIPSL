...
model DCBusBar
  ...
  Modelica.Blocks.Nonlinear.Limiter limiter1(uMax=876, uMin=0) annotation (
      Placement(transformation(
        origin={100.0,0.0},
        extent={{-10.0,-10.0},{10.0,10.0}})));
  OpenIPSL.Electrical.Solar.PowerFactory.DigSILENT_PVSystem.PFblocks.Auxiliary.Calcurrent
    calcurrent1(Udc0=Udc0) annotation (Placement(transformation(origin={-108.3112,
            -33.4951}, extent={{-10.0,-10.0},{10.0,10.0}})));
  OpenIPSL.Electrical.Solar.PowerFactory.DigSILENT_PVSystem.PFblocks.Auxiliary.AtoPU
    atoPU1(Pnen=Pnen, UdcN=UdcN) annotation (Placement(transformation(origin={-22.2363,
            0.0}, extent={{-10.0,-10.0},{10.0,10.0}})));
  OpenIPSL.Electrical.Solar.PowerFactory.DigSILENT_PVSystem.PFblocks.Auxiliary.Capacitor
    capacitor1(
    C=C,
    Udc0=Udc0,
