...
model Controller
  ...
  parameter SI.PerUnit Ft0 = 0.99 "Frequency tripping repose curve point 0";
  parameter SI.PerUnit Ft1 = 0.995 "Frequency tripping repose curve point 1";
  parameter SI.PerUnit Ft2 = 1.005 "Frequency tripping repose curve point 2";
  parameter SI.PerUnit Ft3 = 1.01 "Frequency tripping repose curve point 2";
  parameter SI.PerUnit Vt0 = 0.88 "Voltage tripping repose curve point 0";
  parameter SI.PerUnit Vt1 = 0.9 "Voltage tripping repose curve point 1";
  parameter SI.PerUnit Vt2 = 1.1 "Voltage tripping repose curve point 2";
  parameter SI.PerUnit Vt3 = 1.2 "Voltage tripping repose curve point 3";
